...
parser.add_argument('-ne', help='Number of epochs', type=int, default=5)
...
parser.add_argument('-save_each', help='Save model and validate each K epochs', type=int, default=1, choices = [20,1])
